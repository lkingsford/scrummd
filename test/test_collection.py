...
def test_get_basic_collection(data_config):
    ...
    test_collection = get_collection_from_fs(data_config, "collection1")
...
def test_get_basic_subcollection(data_config):
    ...
    test_collection = get_collection_from_fs(data_config, "collection1.embedded")
...
def test_get_collection_with_tags_and_folder(data_config):
    ...
    test_collection = get_collection_from_fs(data_config, "collection2")
    indices = test_collection.keys()
...
def test_get_collection_with_tags(data_config):
    ...
    test_collection = get_collection_from_fs(data_config, "special")
    indices = test_collection.keys()
...
def test_reference_collection(data_config, collection_name, expected_items):
    """Test that items"""
    test_collection = get_collection_from_fs(data_config, collection_name)
    indices = test_collection.keys()
...
def test_index_set(data_config):
    ...
    test_collection = get_collection_from_fs(data_config)
...
def test_collection_with_rules(data_config):
    ...
    collection4 = get_collection_from_fs(data_config, "collection4").values()
...
def test_collection_with_invalid_collection_rules(data_config):
    ...
    with pytest.raises(RuleViolationError):
        get_collection_from_fs(config, "collection4")
...
def test_get_collection_maintains_listed_order(data_config):
    ...
    test_collection = get_collection_from_fs(data_config, "sort_collection")
